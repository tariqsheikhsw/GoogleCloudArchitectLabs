...
gcloud compute instances create on-prem-instance1 --zone europe-west1-c --subnet on-prem-subnet1


### Task 3. HA-VPN setup

gcloud beta compute vpn-gateways create vpc-demo-vpn-gw1 --network vpc-demo --region europe-west1

gcloud beta compute vpn-gateways create on-prem-vpn-gw1 --network on-prem --region europe-west1

gcloud beta compute vpn-gateways describe vpc-demo-vpn-gw1 --region europe-west1

gcloud beta compute vpn-gateways describe on-prem-vpn-gw1 --region europe-west1
...
gcloud compute ssh on-prem-instance1 --zone europe-west1-c
(y)
ping 10.1.1.2
