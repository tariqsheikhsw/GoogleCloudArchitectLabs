### GSP1007 :  Creating Dynamic Secrets for Google Cloud with Vault 

### Run the following Commands in CloudShell

```
curl -LO https://raw.githubusercontent.com/tariqsheikhsw/GoogleCloudArchitectLabs/main/Solutions/GSP1007.sh
...
### GSP1007 :  Creating Dynamic Secrets for Google Cloud with Vault ( OLD METHOD ) - ALTERNATIVE 

### Run the following Commands in CloudShell

```
curl -LO https://raw.githubusercontent.com/tariqsheikhsw/GoogleCloudArchitectLabs/main/Solutions/GSP1007-old.sh

sudo chmod +x GSP1007-old.sh
