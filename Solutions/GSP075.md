...
## Run in cloudshell
```cmd
curl -LO https://raw.githubusercontent.com/tariqsheikhsw/GoogleCloudArchitectLabs/main/Solutions/GSP075.sh
...
### GSP075 (OLD METHOD - OPTIONAL)  


//Change region from 'us-central1' to 'us-east1' if face issues/constraints.
