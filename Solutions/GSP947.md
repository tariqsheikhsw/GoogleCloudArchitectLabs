### GSP947 :  Getting Started with Splunk Cloud GDI on Google Cloud 

# Command for Getting Started with Splunk Cloud GDI on Google Cloud:- 
...
gcloud iam service-accounts create ${SPLUNK_SERVICE_ACCOUNT} --description "Google CSB"
