...
TASK 1:- 
```
export BUCKET_ID=qwiklabs-gcp-03-47640fc8d8a5
...
gcloud run deploy ohif-viewer --image=gcr.io/qwiklabs-resources/ohif-viewer:latest --platform=managed --region=us-east4 --allow-unauthenticated --set-env-vars=CLIENT_ID=343517506733-kpj2341fuu408u6joptm4sct0tb336jp.apps.googleusercontent.com --max-instances=3
...
gcloud run deploy ohif-viewer11 --image=gcr.io/qwiklabs-resources/ohif-viewer:latest --platform=managed --region=us-east4 --allow-unauthenticated --set-env-vars=CLIENT_ID=343517506733-kpj2341fuu408u6joptm4sct0tb336jp.apps.googleusercontent.com --max-instances=3
```
