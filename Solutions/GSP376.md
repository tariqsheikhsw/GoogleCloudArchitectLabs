### GSP376 : Get Started with Google Workspace Tools: Challenge Lab 
...
3. Give this signature `gcplab` name, then click `Create`.
...
3. Add a title, for example, `Weekly status check`. (recurring every Friday of Week)
...
3. For `App name`, type `gcplab` to name your app.
