...
WITH deaths_by_states AS (
    ...
    FROM `bigquery-public-data.covid19_open_data.covid19_open_data`
    WHERE country_name="United States of America" and date='2020-06-15' and subregion1_name is NOT NULL
...
SELECT * FROM (
    ...
    FROM `bigquery-public-data.covid19_open_data.covid19_open_data`
    WHERE country_code="US" AND date='2020-06-15' AND subregion1_name is NOT NULL
    GROUP BY subregion1_name
...
WITH india_cases_by_date AS (
    ...
    FROM `bigquery-public-data.covid19_open_data.covid19_open_data`
    WHERE country_name ="India" AND date BETWEEN '2020-02-22' AND '2020-03-12'
    GROUP BY date
    ORDER BY date ASC
...
WITH france_cases AS (
    ...
    FROM `bigquery-public-data.covid19_open_data.covid19_open_data`
    WHERE country_name="France" AND date IN ('2020-01-24', '2020-06-15')
    GROUP BY date
    ORDER BY date
), summary AS (
...
FROM `bigquery-public-data.covid19_open_data.covid19_open_data`
WHERE date BETWEEN '2020-03-28' AND '2020-04-20'
