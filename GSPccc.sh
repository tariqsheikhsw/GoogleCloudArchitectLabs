    ...
    "backends": [
      {
        "balancingMode": "RATE",
        "capacityScaler": 1,
        "group": "projects/'"$DEVSHELL_PROJECT_ID"'/regions/'"$REGION"'/instanceGroups/us-central1-mig",
        "maxRatePerInstance": 50
      },
      {
        "balancingMode": "UTILIZATION",
        "capacityScaler": 1,
        "group": "projects/'"$DEVSHELL_PROJECT_ID"'/regions/'"$REGION_2"'/instanceGroups/europe-west1-mig",
        "maxUtilization": 0.8
      }
    ],
    "cdnPolicy": {
...
sleep 30
  ...
  "https://compute.googleapis.com/compute/beta/projects/$DEVSHELL_PROJECT_ID/regions/$REGION_2/instanceGroups/europe-west1-mig/setNamedPorts"
...
curl -X POST -H "Content-Type: application/json" \
  ...
  "https://compute.googleapis.com/compute/beta/projects/$DEVSHELL_PROJECT_ID/regions/$REGION/instanceGroups/us-central1-mig/setNamedPorts"
